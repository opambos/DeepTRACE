...
%pc_progress    (float)     progress through labelling (%), this value is the number of labelled molecules divided by the number filtered, note that molecules can be removed from the filtered list when discarded in the event labeller;
