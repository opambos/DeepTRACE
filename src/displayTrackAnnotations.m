...
%Display and compare track annotations, 05/07/2024.
%
...
%extractLabels()    - local to this .m file
    ...
    {'GroundTruth',  'VisuallyLabelled',  'LSTMLabelled',           'BiLSTMLabelled',           'RFLabelled',           'GRULabelled',           'BiGRULabelled',           'ResAnDi'}, ...
    {'Ground truth', 'Human annotations', 'LSTM model annotations', 'BiLSTM model annotations', 'RF model annotations', 'GRU model annotations', 'BiGRU model annotations', 'ResAnDi2 annotations'});
...
%Extracts annotations from a given LabelledMols cell array, 05/07/2024.
%
%Author: Oliver J. Pambos, Department of Physics, University of Oxford, UK
%(oliver.pambos@physics.ox.ac.uk).
%
...
%Extracts track data from the selected track for plotting, 05/07/2024.
%
%Author: Oliver J. Pambos, Department of Physics, University of Oxford, UK
%(oliver.pambos@physics.ox.ac.uk).
%
