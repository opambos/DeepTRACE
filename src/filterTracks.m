...
%Filter tracks to ensure there is only one track per cell, 11/09/2020.
%
...
%Compile a list of all tracks overlapping with reference track, 11/09/2020.
%
%Author: Oliver J. Pambos, Department of Physics, University of Oxford, UK
%(oliver.pambos@physics.ox.ac.uk).
%
...
%Identify tracks shorter than the minimum track length, 11/09/2020.
%
%Author: Oliver J. Pambos, Department of Physics, University of Oxford, UK
%(oliver.pambos@physics.ox.ac.uk).
%
...
%Apply memory parameter to the tracks in a single cell, 22/02/22.
%
%Author: Oliver J. Pambos, Department of Physics, University of Oxford, UK
%(oliver.pambos@physics.ox.ac.uk).
%
...
%Remove the cells that contain no tracks, 21/03/2023.
%
%Author: Oliver J. Pambos, Department of Physics, University of Oxford, UK
%(oliver.pambos@physics.ox.ac.uk).
%
...
%same time (very strict), 06/07/2023.
%
%Author: Oliver J. Pambos, Department of Physics, University of Oxford, UK
%(oliver.pambos@physics.ox.ac.uk).
%
