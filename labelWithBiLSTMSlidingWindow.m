...
%reformatToDLArray()    - local to this .m file
    ...
    %===============================================================
    [data_dlarray, source_track] = reformatToDLArray(app.movie_data.results.BiLSTMLabelled.LabelledMols, app.movie_data.models.BiLSTM.max_len, feature_cols);
    ...
    switch app.movie_data.models.BiLSTM.feature_scaling
        ...
        case "Z-score"
            ...
            for jj = 1:numel(feature_cols)
                mean_val = app.movie_data.models.BiLSTM.feature_means(jj);
                std_val = app.movie_data.models.BiLSTM.feature_stds(jj);
        ...
        case "Normalise (0-1)"
            ...
            for jj = 1:numel(feature_cols)
                min_val = app.movie_data.models.BiLSTM.feature_mins(jj);
                max_val = app.movie_data.models.BiLSTM.feature_maxs(jj);
    ...
    tic
    %classify all tracks
    raw_scores = predict(app.movie_data.models.BiLSTM.model, scaled_data_dlarray);
    t = toc;
    
    %convert raw scores to probabilities
    probabilities = softmax(raw_scores);
    
    [tracks_cell_array] = computeConsensus(app.movie_data.results.BiLSTMLabelled.LabelledMols, probabilities, source_track);
    
    %write the results back to the original cell array
    app.movie_data.results.BiLSTMLabelled.LabelledMols = tracks_cell_array;
    
    app.textout.Value = "Completed classification and segmentation of entire dataset using Bidirectional Long Short-Term Memory model. Classification took " + num2str(t) +...
