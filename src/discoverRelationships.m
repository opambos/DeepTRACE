...
%Discover relationships in any feature not used by model, 15/02/2025.
%
...
%names used by the model to classify, 15/02/2025.
%
%Author: Oliver J. Pambos, Department of Physics, University of Oxford, UK
%(oliver.pambos@physics.ox.ac.uk).
%
...
%the code a little.
%
%Checking of substructs here can be dramatically simplified now that
%function calls pass through my catchInvalidComponentActions() function
%during GUI callback.
%
%Inputs
%------
...
%Plot the discovery results graphically, 15/02/2025.
%
%Author: Oliver J. Pambos, Department of Physics, University of Oxford, UK
%(oliver.pambos@physics.ox.ac.uk).
%
